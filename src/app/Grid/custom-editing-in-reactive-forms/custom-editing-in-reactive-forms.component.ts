...
const createFormGroup = dataItem => new FormGroup({
    ...
    'DogID': new FormControl(dataItem.DogID, Validators.required)
});
@Component({
  selector: 'app-custom-editing-in-reactive-forms',
  templateUrl: './custom-editing-in-reactive-forms.component.html',
  styleUrls: ['./custom-editing-in-reactive-forms.component.scss']
})
export class CustomEditingInReactiveFormsComponent implements OnInit {

  public gridData: any[];
  public dogs:any[]=dogs;
    ...
    public dog(id: number): any {
      return this.dogs.find(x => x.DogID === id);
  }
